...
const Hero = () => {
  ...
  return (
    <section className="min-h-screen flex items-center justify-center section-padding relative overflow-hidden">
      ...
      {/* Background Elements */}
      <div className="absolute top-20 left-10 w-72 h-72 bg-teal/5 rounded-full blur-3xl float"></div>
      <div className="absolute bottom-20 right-10 w-96 h-96 bg-purple/5 rounded-full blur-3xl float" style={{animationDelay: '2s'}}></div>
    </section>
  );
};
